...
var Carousel = /*#__PURE__*/function () {
  ...
  _createClass(Carousel, [{
    ...
    value: function createNavigation() {
      ...
      var btnCarouel = document.querySelector(".carousel__btn");
    ...
    key: "next",
    value: function next() {
      document.querySelector(".carousel__container").style.transform = "translate3d(-9%, 0, 0)";
    ...
    key: "prev",
    value: function prev() {
      document.querySelector(".carousel__container").style.transform = "translate3d(0, 0, 0)";
      this.classList.add("disabled");
...
var elems = document.getElementsByClassName("hide-mobile");
var arr = [].slice.call(elems);
btn.addEventListener("click", function () {
  for (var index = 0; index < elems.length + 1; index++) {
